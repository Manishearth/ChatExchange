...
Supported Python versions (currently checked by Travis-CI): `2.7` `3.2` `3.3` `3.4` `3.5-dev`  
Python versions with previously failing Travis-CI builds (now excluded from tests): `2.6` `3.5` `3.6-dev (nightly)`
